...
public class AnnounceCommentPageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)actionBar.getCustomView().findViewById(R.id.textView_screen_title)).setText(getString(R.string.title_activity_announce_comment_page));
        ...
        setContentView(R.layout.activity_announce_comment_page);

        setupUI(findViewById(R.id.rl_comment_page));
    ...
    public void loadMoreData(String startId) {
        if (!networkConnect()) {
            Toast.makeText(AnnounceCommentPageActivity.this, getResources().getString(R.string.unconnected), Toast.LENGTH_SHORT).show();
            System.out.println("Unconnected!");
            return;
        }
        moreCommentTask = new AnnounceCommentMoreFetchTask(this, aid, listView, adapter, moreView, Integer.valueOf(startId));
    ...
    public void fetchData() {
        ...
        fetchAnnounceTask = new AnnounceCommentFetchTask(this, aid, listView, adapter, moreView);
    ...
    public void onClickSubmitAnnounceComment(View view){
        ...
        if(isLoggedIn) {
            ...
            addAnnounceCommentTask = new AddAnnounceCommentTask(this, str_comment, session_id, aid);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(AnnounceCommentPageActivity.this);
                    return false;
                }
    ...
    public void hideSoftKeyboard(Activity activity) {
        ...
        //((TextView)findViewById(R.id.txt_hide_parent_comm_id)).setText("");
        EditText et_comment = (EditText)findViewById(R.id.et_announce_comment);

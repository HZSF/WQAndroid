...
public class AnnounceCommentMoreFetchTask extends AsyncTask<String, Void, String> {
    ...
    public AnnounceCommentMoreFetchTask(Activity mActivity, String announceId, ListView listView, AnnounceCommentListAdapter adapter,View moreView, int startId){
        super();

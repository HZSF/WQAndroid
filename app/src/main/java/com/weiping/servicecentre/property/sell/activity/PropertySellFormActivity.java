package com.weiping.servicecentre.property.sell.activity;
...
import com.weiping.servicecentre.property.sell.asyncTasks.PropertySellFormUploadTask;

import platform.tyk.weping.com.weipingplatform.R;

public class PropertySellFormActivity extends Activity {
    private String area = "";
    private String category = "";
    public PropertySellFormUploadTask task;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)actionBar.getCustomView().findViewById(R.id.textView_screen_title)).setText(getString(R.string.title_activity_property_sell_form));
        ...
        setContentView(R.layout.activity_property_sell_form);
        setSpinnerView();
    }
    ...
    public void onClickSubmitForm(View view){
        ...
        if(!networkConnect()){
            Toast.makeText(PropertySellFormActivity.this, getResources().getString(R.string.unconnected), Toast.LENGTH_SHORT).show();
            System.out.println("Unconnected!");
            return;
        }

        task = new PropertySellFormUploadTask(this, area, category, property_area, levels, ask_price, description);
        task.execute(Constants.URL_PROPERTY_ADD_SELL);
    }

package com.weiping.servicecentre.property.buy.adapter;
...
public class PropertySellingListAdapter extends ArrayAdapter<PropertySellingListItem> {
    private Context context;
    private ArrayList<PropertySellingListItem> itemArrayList;
    private boolean downloading = false;

    public PropertySellingListAdapter(Context context, ArrayList<PropertySellingListItem> itemArrayList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        btn_add_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PropertyAddFavoritesTask task = new PropertyAddFavoritesTask(v.getContext(), itemArrayList.get(position).getId(), 1);

...
public class PropertyFavoriteSellFetchTask extends AsyncTask<String, Void, String> {
    ...
    public PropertyFavoriteSellFetchTask(Activity activity, ListView listView, PropertyFavoriteSellListAdapter adapter, View moreView){
        super();
        mActivity = activity;

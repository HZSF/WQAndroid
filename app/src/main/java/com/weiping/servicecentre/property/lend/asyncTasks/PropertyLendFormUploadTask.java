package com.weiping.servicecentre.property.lend.asyncTasks;
...
public class PropertyLendFormUploadTask extends AsyncTask<String, Void, String> {
    ...
    public PropertyLendFormUploadTask(Activity activity, String area, String category, String property_area, String levels, String ask_price, String description){
        super();
        mActivity = activity;
        this.area = area;

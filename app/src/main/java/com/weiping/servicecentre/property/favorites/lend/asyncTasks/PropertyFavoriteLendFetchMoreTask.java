...
public class PropertyFavoriteLendFetchMoreTask extends AsyncTask<String, Void, String> {
    ...
    public PropertyFavoriteLendFetchMoreTask(Activity mActivity, ListView listView, PropertyFavoriteLendListAdapter adapter, View moreView, int startId) {
        super();

...
public class PropertySellingFetchMoreTask extends AsyncTask<String, Void, String> {
    ...
    public PropertySellingFetchMoreTask(Activity mActivity, ListView listView, PropertySellingListAdapter adapter, View moreView, int startId) {
        super();

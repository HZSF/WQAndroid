package com.weiping.servicecentre.quality.wood.asyncTasks;
...
public class SubmitWoodInspectionAppointTask extends AsyncTask<String, Void, String> {
    ...
    public SubmitWoodInspectionAppointTask(Activity a){
        super();
        mActivity = a;

package com.weiping.servicecentre.quality.kids.asyncTasks;
...
public class SubmitKidsInspectionAppointTask extends AsyncTask<String, Void, String> {
    ...
    public SubmitKidsInspectionAppointTask(Activity a){
        super();
        mActivity = a;

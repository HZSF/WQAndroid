...
public class AnnFeeMonitorSubmitTask extends AsyncTask<String, Void, String> {
    ...
    public AnnFeeMonitorSubmitTask(Context a, String patentId, String patentTitle, String applyDate, String applicant){
        super();
        context = a;
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            jsonObject.put("patentId", patentId);
            jsonObject.put("patentTitle", URLEncoder.encode(URLEncoder.encode(patentTitle, "UTF-8"), "UTF-8"));
            jsonObject.put("applyDate",applyDate);
            jsonObject.put("applicant",URLEncoder.encode(URLEncoder.encode(applicant, "UTF-8"), "UTF-8"));

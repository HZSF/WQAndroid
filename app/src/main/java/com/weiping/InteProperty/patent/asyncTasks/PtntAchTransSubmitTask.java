...
public class PtntAchTransSubmitTask extends AsyncTask<String, Void, String> {
    ...
    public PtntAchTransSubmitTask(Context context, String patentId, String patentTitle, String price) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            jsonObject.put("title", URLEncoder.encode(URLEncoder.encode(patentTitle, "UTF-8"), "UTF-8"));

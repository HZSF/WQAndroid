...
public class SubmitCourseDeregistrationTask extends AsyncTask<String, Void, String> {
    ...
    public SubmitCourseDeregistrationTask(Activity a, String string){
        super();
        mActivity = a;
    ...
    protected String doInBackground(String... params) {
        try{
            ...
            StringEntity se = new StringEntity(keyword_course_id);

...
public class AppointedInspectionTextileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)actionBar.getCustomView().findViewById(R.id.textView_screen_title)).setText(getString(R.string.title_activity_appointed_inspection_textile));
        ...
        setContentView(R.layout.activity_appointed_inspection_textile);
        TextView textile_text1 = (TextView)findViewById(R.id.txt_membership_quality_textile1);
        TextView textile_text2 = (TextView)findViewById(R.id.txt_membership_quality_textile2);
    ...
    public void onClickListenerCancelAppointTextileInspection(View view){
        if(!networkConnect()){
            Toast.makeText(AppointedInspectionTextileActivity.this, getResources().getString(R.string.unconnected), Toast.LENGTH_SHORT).show();
        ...
        if(isLoggedIn){
            ...
            cancelAppointedInspectionTask.execute(Constants.URL_MEMBER_QUALITY_CANCEL_APPOINTED_INSPECTION_TEXTILE);
        }else{

...
public class AppointedInspectionKidsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointed_inspection_kids);
    }

    public void onClickListenerCancelAppointKidsInspection(View view){
        if(!networkConnect()){
            Toast.makeText(AppointedInspectionKidsActivity.this, getResources().getString(R.string.unconnected), Toast.LENGTH_SHORT).show();
        ...
        if(isLoggedIn){
            ...
            cancelAppointedInspectionTask.execute(Constants.URL_MEMBER_QUALITY_CANCEL_APPOINTED_INSPECTION_KIDS);
        }else{

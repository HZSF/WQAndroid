package com.weiping.membership.healthy.asyncTasks;
...
public class BookedHealthCheckFetchTask extends AsyncTask<String, Void, String> {
    ...
    public BookedHealthCheckFetchTask(Activity a){
        super();
        mActivity = a;
    ...
    protected void onPostExecute(String result){
        ...
        if (Constants.NO.equalsIgnoreCase(result)){
        ...
        }else if(Constants.YES.equalsIgnoreCase(result)){
            mActivity.setContentView(R.layout.activity_booked_healthy);
        }else{
            notLoginDialogBuilder
                    .setMessage("请登录！")
                    .setPositiveButton(mActivity.getResources().getString(R.string.dialog_btn_OK), new DialogInterface.OnClickListener() {

...
public class CancelAppliedLendingTask extends AsyncTask<String, Void, String> {
    private Activity mActivity;
    protected ProgressDialog progressDialog;
    private AbstractHttpClient mClient;
    private HttpPost httpPost;
    private String keyword_lend_id = "";
    ...
    public CancelAppliedLendingTask(Activity a, String string){
        super();
        mActivity = a;
        keyword_lend_id = string;
    ...
    protected String doInBackground(String... params) {
        try{
            ...
            StringEntity se = new StringEntity(keyword_lend_id);
